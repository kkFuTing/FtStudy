        ...
        for (i in 0 until childCount) {
            ...
            if (childView.visibility != GONE) {
                ...
                if (childMesauredWidth + lineWidthUsed + mHorizontalSpacing > selfWidth) {
                    ...
                    parentNeededWidth = max(
                        parentNeededWidth.toDouble(),
                        (lineWidthUsed + mHorizontalSpacing).toDouble()
                    )
                        .toInt()
                ...
                lineHeight = max(lineHeight.toDouble(), childMeasuredHeight.toDouble()).toInt()
