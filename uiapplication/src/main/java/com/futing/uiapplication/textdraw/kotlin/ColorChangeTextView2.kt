package com.futing.uiapplication.textdraw.kotlin
...
constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0, defStyleRes: Int = 0) :
    ...
    init {
        ...
        textSize =
            ta.getDimensionPixelSize(R.styleable.ColorChangeTextView1_text_size, textSize.toInt())
                .toFloat()
    ...
    private fun measureHeight(measureSpec: Int): Int {
        ...
        when (mode) {
            ...
            MeasureSpec.AT_MOST, MeasureSpec.UNSPECIFIED -> result =
                (mTextBound.height() + .5f).toInt() + paddingTop + paddingBottom
        }
            ...
            DIRECTION_LEFT -> {
                ...
                canvas?.apply {
                    ...
                    drawText(
                        text,
                        mTextStartX.toFloat(),
                        measuredHeight / 2 - (mPaint.descent() / 2 + mPaint.ascent() / 2),
                        mPaint
                    )
                    restore()
